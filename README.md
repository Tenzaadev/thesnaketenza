...
- Экран можно очистить методом screen.fill(), заполнив его фоновым цветом (BOARD_BACKGROUND_COLOR). Это удаляет оставшиеся части змейки с экрана, подготавливая его к новой игре.#   t h e s n a k e t e n z a  
 